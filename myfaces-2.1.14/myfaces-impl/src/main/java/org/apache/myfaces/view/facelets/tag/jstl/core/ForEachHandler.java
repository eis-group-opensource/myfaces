...
import org.apache.myfaces.view.facelets.el.CachedValueExpression;
 ...
 * @version $Id: ForEachHandler.java 1351610 2012-06-19 08:55:52Z lu4242 $
 */
...
public final class ForEachHandler extends TagHandler implements ComponentContainerHandler
{
            ...
            ELException
    {
        ...
        if (this.items != null)
        {
            srcVE = new CachedValueExpression(this.items.getValueExpression(ctx, Object.class), ctx, tagId);
