 ...
 * @version $Revision: 1424976 $ $Date: 2012-12-21 10:41:52 -0500 (Fri, 21 Dec 2012) $
 *
 * @since 2.0
 */
public class ComponentTagHandlerDelegate extends TagHandlerDelegate
{
     ...
     * javax.faces.view.facelets.TagHandler#setAttributes(FaceletCompositionContext, Object) attribute</li>
     ...
     * then #finalizeForDeletion(FaceletCompositionContext, UIComponent) finalize
     * for deletion.</li>
     * </ol>
     * 
