...
/**
 * Method {@link #getBoolean(FaceletContext)} is patched by EIS to fix NPE after bad coercion in Tomcat 8 EL.
 * The same is done for the Strings in {@link #getValue(FaceletContext)}
 * 
 * @since 7.1.14
 * @author szacharov
 * 
 ...
 * 
 * @author Jacob Hookom
 * @version $Id: TagAttributeImpl.java 1383168 2012-09-10 23:57:29Z lu4242 $
 */
public final class TagAttributeImpl extends TagAttribute
{
    ...
    public boolean getBoolean(FaceletContext ctx)
    {
        ...
        {
            return BooleanUtils.toBoolean((Boolean) getObject(ctx, Boolean.class));
        }
    }
    ...
    public String getValue(FaceletContext ctx)
    {
        ...
        {
            String coercedValue = (String) getObject(ctx, String.class);
            return null != coercedValue ? coercedValue : StringUtils.EMPTY;
        }
    }
